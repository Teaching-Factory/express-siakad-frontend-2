...
export const getFeederAgama = async () => {
    try {
        const res = await get(`api-feeder/get-agama`);
        isAgama = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederNegara = async () => {
    try {
        const res = await get(`api-feeder/get-negara`);
        isNegara = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederWilayah = async () => {
    try {
        const res = await get(`api-feeder/get-wilayah`);
        isWilayah = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederPerguruanTinggi = async () => {
    try {
        const res = await get(`api-feeder/get-all-pt`);
...
export const getFeederProfilePT = async () => {
    try {
        const res = await get(`api-feeder/get-profil-pt`);
        isProfilePT = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederJalurMasuk = async () => {
    try {
        const res = await get(`api-feeder/get-jalur-masuk`);
        isJalurMasuk = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederJenisPendaftaran = async () => {
    try {
        const res = await get(`api-feeder/get-jenis-pendaftaran`);
...
export const getFeederJenisTinggal = async () => {
    try {
        const res = await get(`api-feeder/get-jenis-tinggal`);
        isJenisTinggal = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederAlatTransportasi = async () => {
    try {
        const res = await get(`api-feeder/get-alat-transportasi`);
...
export const getFeederStatusMahasiswa = async () => {
    try {
        const res = await get(`api-feeder/get-status-mahasiswa`);
...
export const getFeederKebutuhanKhusus = async () => {
    try {
        const res = await get(`api-feeder/get-kebutuhan-khusus`);
...
export const getFeederPenghasilan = async () => {
    try {
        const res = await get(`api-feeder/get-penghasilan`);
        isPenghasilan = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederJenisSms = async () => {
    try {
        const res = await get(`api-feeder/get-jenis-sms`);
        isJenisSms = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederLembagaPengangkatan = async () => {
    try {
        const res = await get(`api-feeder/get-lembaga-pengangkatan`);
...
export const getFeederStatusKeaktifanPegawai = async () => {
    try {
        const res = await get(`api-feeder/get-status-keaktifan-pegawai`);
...
export const getFeederPangkatGolongan = async () => {
    try {
        const res = await get(`api-feeder/get-pangkat-golongan`);
...
export const getFeederPekerjaan = async () => {
    try {
        const res = await get(`api-feeder/get-pekerjaan`);
        isPekerjaan = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederDosen = async () => {
    try {
        const res = await get(`api-feeder/get-dosen`);
        isDosen = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederBiodataDosen = async () => {
    try {
        const res = await get(`api-feeder/get-biodata-dosen`);
        isBiodataDosen = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederJenjangPendidikan = async () => {
    try {
        const res = await get(`api-feeder/get-jenjang-pendidikan`);
...
export const getFeederProgramStudi = async () => {
    try {
        const res = await get(`api-feeder/get-prodi`);
        isProgramStudi = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederPeriode = async () => {
    try {
        const res = await get(`api-feeder/get-periode`);
        isPeriode = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederJenisSubtansi = async () => {
    try {
        const res = await get(`api-feeder/get-jenis-substansi`);
...
export const getFeederSubtansi = async () => {
    try {
        const res = await get(`api-feeder/get-substansi`);
        isSubtansi = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederSubtansiKuliah = async () => {
    try {
        const res = await get(`api-feeder/get-substansi-kuliah`);
...
export const getFeederMataKuliah = async () => {
    try {
        const res = await get(`api-feeder/get-mata-kuliah`);
        isMataKuliah = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederTahunAjaran = async () => {
    try {
        const res = await get(`api-feeder/get-tahun-ajaran`);
        isTahunAjaran = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederFakultas = async () => {
    try {
        const res = await get(`api-feeder/get-fakultas`);
        isFakultas = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederSemester = async () => {
    try {
        const res = await get(`api-feeder/get-semester`);
        isSemester = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederKurikulum = async () => {
    try {
        const res = await get(`api-feeder/get-kurikulum`);
        isKurikulum = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederDetailKurikulum = async () => {
    try {
        const res = await get(`api-feeder/get-detail-kurikulum`);
...
export const getFeederPenugasanDosen = async () => {
    try {
        const res = await get(`api-feeder/get-penugasan-dosen`);
...
export const getFeederMataKuliahKurikulum = async () => {
    try {
        const res = await get(`api-feeder/get-matkul-kurikulum`);
...
export const getFeederKelasKuliah = async () => {
    try {
        const res = await get(`api-feeder/get-kelas-kuliah`);
        isKelasKuliah = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederDetailKelasKuliah = async () => {
    try {
        const res = await get(`api-feeder/get-detail-kelas-kuliah`);
...
export const getFeederPerhitunganSKS = async () => {
    try {
        const res = await get(`api-feeder/get-perhitungan-sks`);
...
export const getFeederBiodataMahasiswa = async () => {
    try {
        const res = await get(`api-feeder/get-biodata-mahasiswa`);
...
export const getFeederMahasiswa = async () => {
    try {
        const res = await get(`api-feeder/get-mahasiswa`);
        isMahasiswa = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederJenisKeluar = async () => {
    try {
        const res = await get(`api-feeder/get-jenis-keluar`);
        isJenisKeluar = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederPembiayaan = async () => {
    try {
        const res = await get(`api-feeder/get-pembiayaan`);
        isPembiayaan = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederBidangMinat = async () => {
    try {
        const res = await get(`api-feeder/get-bidang-minat`);
        isBidangMinat = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederRiwayatPendidikanMahasiswa = async () => {
    try {
        const res = await get(`api-feeder/get-riwayat-pendidikan-mahasiswa`);
...
export const getFeederSkalaNilaiProdi = async () => {
    try {
        const res = await get(`api-feeder/get-skala-nilai-prodi`);
...
export const getFeederPeriodePerkuliahan = async () => {
    try {
        const res = await get(`api-feeder/get-periode-perkuliahan`);
...
export const getFeederDetailPeriodePerkuliahan = async () => {
    try {
        const res = await get(`api-feeder/get-detail-periode-perkuliahan`);
...
export const getFeederJenisAktivitasMahasiswa = async () => {
    try {
        const res = await get(`api-feeder/get-jenis-aktivitas-mahasiswa`);
...
export const getFeederDataLengkapMahasiswaProdi = async () => {
    try {
        const res = await get(`api-feeder/get-data-lengkap-mahasiswa-prodi`);
...
export const getFeederAktivitasMahasiswa = async () => {
    try {
        const res = await get(`api-feeder/get-aktivitas-mahasiswa`);
...
export const getFeederAnggotaAktivitasMahasiswa = async () => {
    try {
        const res = await get(`api-feeder/get-anggota-aktivitas-mahasiswa`);
...
export const getFeederKonversiKampusMerdeka = async () => {
    try {
        const res = await get(`api-feeder/get-konversi-kampus-merdeka`);
...
export const getFeederRekapJumlahMahasiswa = async () => {
    try {
        const res = await get(`api-feeder/get-rekap-jumlah-mahasiswa`);
...
export const getFeederJenisEvaluasi = async () => {
    try {
        const res = await get(`api-feeder/get-jenis-evaluasi`);
...
export const getFeederDosenPengajar = async () => {
    try {
        const res = await get(`api-feeder/get-dosen-pengajar-kelas-kuliah`);
...
export const getFeederKategoriKegiatan = async () => {
    try {
        const res = await get(`api-feeder/get-kategori-kegiatan`);
...
export const getFeederMahasiswaBimbinganDosen = async () => {
    try {
        const res = await get(`api-feeder/get-mahasiswa-bimbingan-dosen`);
...
export const getFeederUjiMahasiswa = async () => {
    try {
        const res = await get(`api-feeder/get-uji-mahasiswa`);
        isUjiMahasiswa = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederSekolahSMK = async () => {
    try {
        const res = await get(`api-external/sekolah/smk/get`);
        isSekolahSMK = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederSekolahSMA = async () => {
    try {
        const res = await get(`api-external/sekolah/sma/get`);
        isSekolahSMA = true;
        return res;
    } catch (err) {
        throw err;
...
export const getFeederRencanaEvaluasi = async () => {
    try {
        const res = await get(`api-feeder/get-rencana-evaluasi`);
        isRencanaEvaluasi = true;
        return res;
    } catch (err) {
        throw err;
    }
};
export const getFeederKomponenEvaluasi = async () => {
    try {
