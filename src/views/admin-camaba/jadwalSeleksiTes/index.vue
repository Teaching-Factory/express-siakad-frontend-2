...
<template>
    <div class="card">
        <h5><i class="pi pi-user me-2"></i>JADWAL SELEKSI TES</h5>
        <DataTable
        ...
        >
            ...
            <Column header="Tahapan Tes" headerStyle="width:10rem">
                <template #body="slotProps">
                    {{ first + slotProps.index + 1 }}
                </template>
            </Column>
            <Column filterField="nama_mahasiswa" header="Jenis Tes" style="min-width: 7rem">
                <template #body="{ data }">
            ...
            <Column filterField="nim" header="Tanggal Tes" style="min-width: 10rem">
                <template #body="{ data }">
                    <div class="flex align-items-center gap-2">
                        <span>{{ data.nim }}</span>
                    </div>
            ...
            <Column filterField="nama_program_studi" header="Keterangan Tes" style="min-width: 15rem">
                <template #body="{ data }">
                    {{ data.Prodi?.nama_program_studi || '-' }}
                </template>
            </Column>
            <Column filterField="nama_status_mahasiswa" header="Status Kelulusan" style="min-width: 10rem">
                <template #body="{ data }">
