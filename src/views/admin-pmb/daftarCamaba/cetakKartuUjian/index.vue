...
const getkartuUjian = async (id) => {
    try {
        ...
        const response = await getData(`camaba/${id}/cetak-kartu-ujian`);
...
const getFotoCamaba = async (id) => {
    try {
        ...
        const response = await getData(`camaba/${id}/get`);
        const data = response.data.data;
        fotoCamaba.value = data;
                            ...
                            <div class="row d-flex align-items-center">
                                ...
                                <div class="col-lg-4 col-md-6 col-4 text-center">
                                    <div class="heading-section" style="width: 100%; display: flex; justify-content: center">
                                        <img :src="`${fotoCamaba?.foto_profil}`" alt="Tanda Tangan" class="img-fluid" style="max-width: 100px; height: auto" />
                                    </div>
                                </div>
