    ...
    <div class="card">
        ...
        <div class="card">
            <DataTable v-model:filters="filters" :globalFilterFields="['id_ruang', 'nama_ruang_perkuliahan']" :value="ruangPerkuliahans" :paginator="true" :rows="10" dataKey="id" :rowHover="true" showGridlines>
                ...
                <Column filterField="id_ruang" header="Nama Syarat" style="min-width: 10rem">
                    <template #body="{ data }">
                ...
                <Column filterField="id_ruang" header="Jumlah" style="min-width: 5rem">
                    <template #body="{ data }">
                        <div class="flex align-items-center gap-2">
                            <span>{{ data.id_ruang }}</span>
                        </div>
                ...
                <Column filterField="id_ruang" header="Wajib" style="min-width: 5rem">
                    <template #body="{ data }">
                        <div class="flex align-items-center gap-2">
                            <span>{{ data.id_ruang }}</span>
                        </div>
                ...
                <Column filterField="id_ruang" header="Upload" style="min-width: 5rem">
                    <template #body="{ data }">
                        <div class="flex align-items-center gap-2">
                            <span>{{ data.id_ruang }}</span>
                        </div>
