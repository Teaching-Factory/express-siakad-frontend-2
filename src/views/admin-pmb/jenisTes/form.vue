    ...
    <div class="card">
        <form @submit.prevent="create">
            ...
            <div class="mb-3 row d-flex justify-content-center">
                <label for="namaRuangPerkuliahan" class="col-sm-3 col-form-label">Nama Tes</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" placeholder="Nama Jenis Tes" id="namaRuangPerkuliahan" v-model="nama_ruang_perkuliahan" />
                </div>
            </div>
            <div class="mb-3 row d-flex justify-content-center">
                <label for="lokasi" class="col-sm-3 col-form-label">Keterangan Singkat</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" placeholder="Keterangan Singkat Jenis Tes" id="lokasi" v-model="lokasi" />
                </div>
            </div>
        </form>
    </div>
