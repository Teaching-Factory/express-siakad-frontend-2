    ...
    <div class="card">
        <h5><i class="pi pi-user me-2"></i>DAFTAR BERITA</h5>
            ...
            >
                ...
                <Column header="Judul" style="min-width: 10rem">
                    <template #body="{ data }">
                ...
                <Column header="Deskripsi Pendek" style="min-width: 15rem">
                    <template #body="{ data }">
                        <div class="flex align-items-center gap-2">
                ...
                <Column header="Penulis" style="min-width: 10rem">
                    <template #body="{ data }">
                        <div class="flex align-items-center gap-2">
                ...
                <Column header="Tanggal Pembuatan" style="min-width: 10rem">
                    <template #body="{ data }">
                        <div class="flex align-items-center gap-2">
                ...
                <Column header="Kategori" style="min-width: 5rem">
                    <template #body="{ data }">
                        <div class="flex align-items-center gap-2">
