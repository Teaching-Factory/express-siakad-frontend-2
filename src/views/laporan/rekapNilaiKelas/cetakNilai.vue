        ...
        getDataNilai: async function (req) {
            try {
                ...
                const response = await getData(
                    `nilai-perkuliahan/get-nilai-perkuliahan-by-filter?id_semester=${req.id_semester}&id_prodi=${req.id_prodi}&nama_kelas_kuliah=${encodedNamaKelas}&format=${req.format}&tanggal_penandatanganan=${req.tanggal_penandatanganan}`
                );
                    ...
                    <tr>
                        <td style="width: 50%">
                            <div style="display: flex; align-items: flex-start">
                                <div style="margin-left: 20px; width: 130px">Program Studi</div>
                            ...
                            <div style="display: flex; align-items: flex-start">
                                <div style="margin-left: 20px; width: 130px">Mata Kuliah</div>
                                <div style="margin-right: 6px">:</div>
                                <div style="margin-right: 10px">
                            ...
                            <div style="display: flex; align-items: flex-start">
                                <div style="margin-left: 20px; width: 130px">Dosen Pengajar</div>
                                <div style="margin-right: 6px">:</div>
                                <div style="margin-right: 10px">
                            ...
                            <div style="display: flex; align-items: flex-start">
                                <div style="margin-left: 20px; width: 130px">Lokasi</div>
                                <div style="margin-right: 6px">:</div>
                                <div style="margin-right: 10px">
                        ...
                        <td style="width: 50%">
                            <div style="display: flex; align-items: flex-start">
                                <div style="margin-left: 20px; width: 130px">Periode</div>
                                <div style="margin-right: 6px">:</div>
                                <div style="margin-right: 10px">
                            ...
                            <div style="display: flex; align-items: flex-start">
                                <div style="margin-left: 20px; width: 130px">Nama Kelas</div>
                                <div style="margin-right: 6px">:</div>
                                <div style="margin-right: 10px">
                            ...
                            <div style="display: flex; align-items: flex-start">
                                <div style="margin-left: 20px; width: 130px">Ruang Perkuliahan</div>
                                <div style="margin-right: 6px">:</div>
                                <div style="margin-right: 10px">
                            ...
                            <div style="display: flex; align-items: flex-start">
                                <div style="margin-left: 20px; width: 130px">Waktu Perkuliahan</div>
                                <div style="margin-right: 6px">:</div>
                                <div style="margin-right: 10px">{{ dataNilai?.DetailKelasKuliahs[0]?.jam_mulai || '00:00' }} - {{ dataNilai?.DetailKelasKuliahs[0]?.jam_selesai || '00:00' }}</div>
                            </div>
                        </td>
                    </tr>
                </tbody>
