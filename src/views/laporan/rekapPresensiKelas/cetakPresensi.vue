        ...
        getDataNilai: async function (req) {
            try {
                ...
                const response = await getData(
                    `rekap-presensi-kelas/get-rekap-presensi-kelas-by-filter?id_semester=${req.id_semester}&id_prodi=${req.id_prodi}&nama_kelas_kuliah=${encodedNamaKelas}&format=${req.format}&tanggal_penandatanganan=${req.tanggal_penandatanganan}`
                );
                ...
                <tbody>
                    <tr>
                        <td style="width: 50%">
                            ...
                            <div style="display: flex; align-items: flex-start">
                                <div style="margin-left: 20px; width: 130px">Nama Dosen</div>
                                <div style="margin-right: 6px">:</div>
                                <div style="margin-right: 10px">
                        ...
                        <td style="width: 50%">
                            <div style="display: flex; align-items: flex-start">
                                <div style="margin-left: 20px; width: 130px">Kelas</div>
                                <div style="margin-right: 6px">:</div>
                                <div style="margin-right: 10px">
                            ...
                            <div style="display: flex; align-items: flex-start">
                                <div style="margin-left: 20px; width: 130px">Jumlah Peserta</div>
                                <div style="margin-right: 6px">:</div>
                                <div style="margin-right: 10px">
                            ...
                            <div style="display: flex; align-items: flex-start">
                                <div style="margin-left: 20px; width: 130px">Jumlah Pertemuan</div>
                                <div style="margin-right: 6px">:</div>
                                <div style="margin-right: 10px">
                            ...
                            <div style="display: flex; align-items: flex-start">
                                <div style="margin-left: 20px; width: 130px">NIDN</div>
                                <div style="margin-right: 6px">:</div>
                                <div style="margin-right: 10px">
