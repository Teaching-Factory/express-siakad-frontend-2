        ...
        <div class="card-body">
            ...
            <div class="row d-flex justify-content-center mb-3">
                ...
                <div class="col-lg-6">
                    <select class="form-select" aria-label="Default select example">
                        ...
                        <option value="3">2022/2023 Ganjil</option>
                    </select>
                </div>
            </div>
            <div class="row d-flex justify-content-center mb-3">
                ...
                <div class="col-lg-6">
                    <select class="form-select" aria-label="Default select example">
                        ...
                        <option value="2">S1 Pendidikan Fisika</option>
                        <option value="3">S1 Pendidikan Kimia</option>
                    </select>
                </div>
            </div>
            <div class="row d-flex justify-content-center mb-3">
                ...
                <div class="col-lg-6">
                    <input type="text" class="form-control" placeholder="Ketikkan Nama Kelas/ Mata Kuliah/Kode Mata Kuliah disini">
                </div>
            </div>
            <div class="row d-flex justify-content-center mb-3">
                <div class="col-lg-4">
                    <label for="exampleFormControlInput1" class="form-label">Tampilkan Mahasiswa Luar Kelas</label>
                </div>
                <div class="col-lg-6">
                    <select class="form-select" aria-label="Default select example">
            ...
            <div class="row ">
                <div class="col-lg-12 d-flex justify-content-center">
                    <router-link to="/cetak-presensi-kelas" class="btn btn-primary">Tampilkan</router-link>
                </div>
            </div>
        </div>
    </div>
