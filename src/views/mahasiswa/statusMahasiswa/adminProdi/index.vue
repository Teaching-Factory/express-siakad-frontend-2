...
const fetchStatusMahasiswa = async () => {
    try {
        ...
        const response = await get('status-mahasiswa/admin-prodi/get-prodi-with-mahasiswa-belum-sk');
...
<template>
    <div class="card">
        <h5><i class="pi pi-user me-2"></i>SET STATUS MAHASISWA - PERIODE {{semesterAktif?.SemesterAktif?.nama_semester}}</h5>
