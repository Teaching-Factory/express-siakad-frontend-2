    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row d-flex justify-content-center mb-3">
                ...
                <div class="col-lg-6">
                    <input type="text" class="form-control" placeholder="masukkan nama perguruan tinggi disini">
                </div>
            </div>
            <div class="row d-flex justify-content-center mb-3">
                <div class="col-lg-4">
                ...
                <div class="col-lg-6">
                    <input type="text" class="form-control" placeholder="masukkan alamat disini">
                </div>
            </div>
            <div class="row d-flex justify-content-center mb-3">
                <div class="col-lg-4">
                ...
                <div class="col-lg-6">
                    <input type="text" class="form-control" placeholder="masukkan telepon disini">
                </div>
            </div>
            <div class="row d-flex justify-content-center mb-3">
                <div class="col-lg-4">
            ...
            <div class="row d-flex justify-content-center mb-3">
                ...
                <div class="col-lg-6">
                    <input type="text" class="form-control" placeholder="masukkan Kode Pos disini">
                </div>
            </div>
            <div class="row d-flex justify-content-center mb-3">
                <div class="col-lg-4">
                ...
                <div class="col-lg-6">
                    <input type="text" class="form-control" placeholder="masukkan fax disini">
                </div>
            </div>
            <div class="row d-flex justify-content-center mb-3">
                <div class="col-lg-4">
                ...
                <div class="col-lg-6">
                    <input type="text" class="form-control" placeholder="masukkan website disini">
                </div>
            </div>
        </div>
    </div>
