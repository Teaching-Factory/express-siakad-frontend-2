    ...
    customer1.value = [
        {
            ...
            namaunsur: 'Ujian Tengah Semester',
            bobot: '30%',
            ...
            no: '2',
            prodi: 'S1 Teknik Informatika',
            namaunsur: 'Ujian Akhir Semester',
            bobot: '40%',
            aksi: `<div class="actions gap-2">
                <router-link to="/import-mahasiswa" class="btn btn-outline-primary"> <i class="pi pi-pencil"></i></router-link>
                <router-link to="/import-mahasiswa" class="btn btn-outline-danger"> <i class="pi pi-trash"></i></router-link>
    ...
    <div class="card">
        <h5><i class="pi pi-user me-2"></i>DAFTAR UNSUR & BOBOT PENILAIAN</h5>
            ...
            >
                ...
                <Column header="Nama Unsur Penilaian" style="min-width: 20rem">
                    <template #body="{ data }">
                        <div class="flex align-items-center gap-2">
                            <span>{{ data.namaunsur }}</span>
                        </div>
                    </template>
                </Column>
                <Column header="Bobot Penilaian" style="min-width: 10rem">
                    <template #body="{ data }">
                        <div class="flex align-items-center gap-2">
