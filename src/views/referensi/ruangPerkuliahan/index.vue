    ...
    <div class="card">
        <h5><i class="pi pi-user me-2"></i>DAFTAR RUANG PERKULIAHAN</h5>
            ...
            >
                ...
                <Column header="ID Ruang" style="min-width: 10rem">
                    <template #body="{ data }">
                        <div class="flex align-items-center gap-2">
                            <span>{{ data.idruang }}</span>
                        </div>
                    </template>
                </Column>
                <Column header="Nama Ruang Perkuliahan" style="min-width: 20rem">
                    <template #body="{ data }">
                        <div class="flex align-items-center gap-2">
                            <span>{{ data.namaruang }}</span>
                        </div>
                    </template>
                </Column>
                <Column header="Lokasi" style="min-width: 10rem">
                    <template #body="{ data }">
                        <div class="flex align-items-center gap-2">
