...
<template>
    <div class="card">
        <h5><i class="pi pi-user me-2"></i>Singkronisasi Kelas Kuliah ke Feeder</h5>
        ...
        <div class="card">
            ...
            :value="kelasKuliah" v-model:selection="selectedKelas" :paginator="true" :rows="10" dataKey="id" :rowHover="true" showGridlines :first="first" @page="onPageChange">
                <template #header>
                    <div class="row">
                        ...
                        <div class="col-lg-6 d-flex justify-content-end">
                            <div class="flex justify-content-end gap-2">
                                <button class="btn btn-secondary"><i class="pi pi-check me-2"></i> Sync</button>
                            </div>
                        </div>
                    </div>
                </template>
                ...
                <Column filterField="semester" header="Semester" style="min-width: 12rem">
                    <template #body="{ data }">
                        <div class="flex align-items-center gap-2">
                            <span>{{ data.KelasKuliah.Semester.nama_semester }}</span>
                        </div>
                    </template>
                </Column>
