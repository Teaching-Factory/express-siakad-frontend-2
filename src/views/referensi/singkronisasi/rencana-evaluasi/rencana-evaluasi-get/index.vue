...
<template>
    <div class="card">
        <h5><i class="pi pi-user me-2"></i>Pengambilan Data Rencana Evaluasi Feeder ke Siakad</h5>
                ...
                <div class="col-12 col-md-6 col-lg-12">
                    ...
                    <p class="lh-1 text-small">
                        <ol>
                            ...
                            <li>Memilih jenis singkron Get untuk Menambahkan data Rencana Evaluasi Terbaru dari Feeder</li>
                        </ol>
                    </p>
                </div>
            </div>
