    ...
    <div class="card">
        <div class="row">
            ...
            <div class="col-lg-8 d-flex justify-content-end">
                ...
                <router-link to="/sistem-kuliah" class="btn btn-primary me-2"><i class="pi pi-check me-2"></i> Simpan</router-link>
        ...
        <div class="mb-3 row d-flex justify-content-center">
            <label for="inputPassword" class="col-sm-2 col-form-label">Nama Sitem Kuliah</label>
            <div class="col-md-8">
                <input type="text" class="form-control" id="inputPassword">
            </div>
        </div>
