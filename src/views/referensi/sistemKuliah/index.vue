    ...
    <div class="card">
        <div class="body">
            ...
            >
                ...
                <Column header="Kode Sistem Kuliah" filterField="kodesk.name" style="min-width: 20rem">
                    <template #body="{ data }">
                ...
                <Column header="Nama Sistem Kuliah" filterField="representative" :showFilterMatchModes="false" :filterMenuStyle="{ width: '14rem' }" style="min-width: 20rem">
                    <template #body="{ data }">
                        <div class="flex align-items-center gap-2">
