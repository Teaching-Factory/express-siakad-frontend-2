    ...
    <div class="card">
        <div class="row">
            ...
            <div class="col-lg-8 d-flex justify-content-end">
                ...
                <router-link to="/unsur-penilaian" class="btn btn-primary me-2"><i class="pi pi-check me-2"></i> Simpan</router-link>
                <router-link to="/unsur-penilaian" class="btn btn-danger"><i class="pi pi-refresh me-2"></i> Batal</router-link>
            </div>
        </div>
        <hr>
        <div class="mb-3 row d-flex justify-content-center">
            <label for="inputPassword" class="col-sm-3 col-form-label">ID Unsur</label>
            <div class="col-md-7">
