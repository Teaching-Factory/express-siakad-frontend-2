    ...
    <div class="card">
        <div class="body">
            ...
            >
                ...
                <Column header="ID Unsur" filterField="kodesk.name" style="min-width: 12rem">
                    <template #body="{ data }">
                ...
                <Column header="Nama Unsur" filterField="representative" :showFilterMatchModes="false" :filterMenuStyle="{ width: '14rem' }" style="min-width: 14rem">
                    <template #body="{ data }">
                        <div class="flex align-items-center gap-2">
